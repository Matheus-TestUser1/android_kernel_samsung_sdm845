...
static int vdd_gx_corner[] = {
	...
	RPMH_REGULATOR_LEVEL_MAX,		/* VDD_GX_MAX - OC level */
};
...
static const struct freq_tbl  ftbl_gpu_cc_gx_gfx3d_clk_src_sdm845_v2[] = {
	F(133000000, P_CRC_DIV,  1, 0, 0),	/* UC: idle mínimo */
	...
	F(840000000, P_CRC_DIV,  1, 0, 0),	/* OC: overclock */
	{ }
};
...
static void gpu_cc_gfx_sdm845_fixup_sdm845v2(void)
{
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_MIN] = 133000000;
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH_L1] =
		710000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_MAX] =
		840000000;
}
